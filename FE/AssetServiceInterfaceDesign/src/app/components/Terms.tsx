            ...
            <div className="text-gray-300 space-y-3">
              ...
              <div className="space-y-4">
                <div className="bg-white/5 p-4 rounded-lg">
                  <h4 className="font-bold text-white">FREE (0đ)</h4>
                  <p>20 lượt hỏi AI miễn phí, truy cập Assets miễn phí</p>
                </div>
                <div className="bg-white/5 p-4 rounded-lg">
                  <h4 className="font-bold text-white">STUDENT (29.000đ/tháng)</h4>
                  <p>100 lượt hỏi AI/tháng, Full Assets Library access</p>
                </div>
                <div className="bg-white/5 p-4 rounded-lg">
                  <h4 className="font-bold text-white">INDIE (99.000đ/tháng)</h4>
                  <p>Unlimited AI queries, 1 giờ tư vấn trực tiếp/tháng, Priority support</p>
                </div>
                <div className="bg-white/5 p-4 rounded-lg">
                  <h4 className="font-bold text-white">PRO (199.000đ/tháng)</h4>
